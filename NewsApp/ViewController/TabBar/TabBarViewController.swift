...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //self.view.backgroundColor = #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1) AA
...
extension TabBarViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            // Music
            self.showViewController(viewController: UINavigationController.self, storyboardId: "BookmarkID")
        case 2:
            // Movies
            self.showViewController(viewController: UINavigationController.self, storyboardId: "ProfileID")
        default:
            break
        }
